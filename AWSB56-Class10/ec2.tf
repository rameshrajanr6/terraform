...
data "aws_ami" "ubuntu" {
  ...
  filter {
    name   = "name"
    values = ["ubuntu/images/hvm-ssd-gp3/ubuntu-noble-24.04-arm64-server-20250821"]
  }
...
resource "aws_instance" "AWSB56-public-Linux" {
